...
namespace GSI.IHUB.Experience.Service.Tests.Setup;

public sealed class TestFixture
{
    public Mock<ILogger<GSI.IHUB.Experience.Service.Functions.ProcessRequestFunction>> LoggerMock { get; } = new();

    public Mock<GSI.IHUB.Experience.Service.Contracts.IExperienceService> ExperienceServiceMock { get; } = new();

    public Mock<GSI.IHUB.Experience.Service.Contracts.IValidationService> ValidationServiceMock { get; } = new();
